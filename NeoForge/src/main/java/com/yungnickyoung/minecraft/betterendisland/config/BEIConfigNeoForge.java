...
public class BEIConfigNeoForge {
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> spawnCentralTowerInitially;
    public static final ModConfigSpec.ConfigValue<Boolean> spawnCentralTowerOnResummon;
